...
option = st.selectbox(
    ...
    ('Delta-Delta', 'Estrella-Estrella', 'Delta-Estrella', 'Estrella-Delta'))
...
if option == 'Delta-Delta':
    ...
    if graphs == 'Corrientes de fase':
        ...
        corriente_ab = lambda x: i_fase[0][0] * math.cos(x + i_fase[0][1])
        corriente_bc = lambda x: i_fase[1][0] * math.cos(x + i_fase[1][1])
        corriente_ca = lambda x: i_fase[2][0] * math.cos(x + i_fase[2][1])

        rango = st.slider('Seleccione el valor maximo de x: ', 0.00, 50.00, 25.00)
        step = 0.01
        ...
        corriente_aa = lambda x: i_linea[0][0] * math.cos(x + i_linea[0][1])
        corriente_bb = lambda x: i_linea[1][0] * math.cos(x + i_linea[1][1])
        corriente_cc = lambda x: i_linea[2][0] * math.cos(x + i_linea[2][1])
        ...
        tension_ab = lambda x: v_fase[0][0] * math.cos(x + v_fase[0][1])
        tension_bc = lambda x: v_fase[1][0] * math.cos(x + v_fase[1][1])
        tension_ca = lambda x: v_fase[2][0] * math.cos(x + v_fase[2][1])
        ...
        tension_ab = lambda x: v_linea[0][0] * math.cos(x + v_linea[0][1])
        tension_bc = lambda x: v_linea[1][0] * math.cos(x + v_linea[1][1])
        tension_ca = lambda x: v_linea[2][0] * math.cos(x + v_linea[2][1])
    ...
    if graphs == 'Corrientes de fase':
        ...
        corriente_an = lambda x: i_fase[0][0] * math.cos(x + i_fase[0][1])
        corriente_bn = lambda x: i_fase[1][0] * math.cos(x + i_fase[1][1])
        corriente_cn = lambda x: i_fase[2][0] * math.cos(x + i_fase[2][1])
        ...
        tension_an = lambda x: v_fase[0][0] * math.cos(x + v_fase[0][1])
        tension_bn = lambda x: v_fase[1][0] * math.cos(x + v_fase[1][1])
        tension_cn = lambda x: v_fase[2][0] * math.cos(x + v_fase[2][1])
        ...
        tension_an = lambda x: v_linea[0][0] * math.cos(x + v_linea[0][1])
        tension_bn = lambda x: v_linea[1][0] * math.cos(x + v_linea[1][1])
        tension_cn = lambda x: v_linea[2][0] * math.cos(x + v_linea[2][1])
